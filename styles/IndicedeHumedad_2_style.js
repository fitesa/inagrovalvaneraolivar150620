...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.246368 && value <= -0.138348) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.138348 && value <= -0.030327) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.030327 && value <= 0.077693) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.077693 && value <= 0.185713) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.185713 && value <= 0.293733) {
            style = [ new ol.style.Style({
