...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.109486 && value <= 0.246783) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.246783 && value <= 0.384081) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.384081 && value <= 0.521378) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.521378 && value <= 0.658676) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.658676 && value <= 0.795973) {
            style = [ new ol.style.Style({
