...
var style_EvolucinIndicedeVegetacin_3 = function(feature, resolution){
    ...
    if (value >= -0.604111 && value <= -0.454304) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.454304 && value <= -0.304497) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.304497 && value <= -0.154690) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.154690 && value <= -0.004882) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.004882 && value <= 0.144925) {
            style = [ new ol.style.Style({
