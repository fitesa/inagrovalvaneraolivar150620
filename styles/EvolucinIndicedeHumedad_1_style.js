...
var style_EvolucinIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.538316 && value <= -0.400837) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.400837 && value <= -0.263358) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.263358 && value <= -0.125879) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.125879 && value <= 0.011600) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.011600 && value <= 0.149079) {
            style = [ new ol.style.Style({
